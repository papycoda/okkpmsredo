...
class Employee(models.Model):
    login_id = models.CharField(max_length=45, blank=True)
    ...
    TNO = models.PositiveIntegerField(primary_key=True,default = 1)
    user_Id = models.CharField(max_length=45, blank = True)
